            ...
            return sentences.map((sentence, index) => {
              ...
              return (
                <React.Fragment key={index}>
                  {sentence}
                  {citationIndex !== null &&
                    allCitations[citationIndex] &&
                    (() => {
                      const cit = allCitations[citationIndex];
                      const tracked = getTrackedLink(
                        cit.uri,
                        { medium: 'limit' },
                        cit.marker
                      );
                      return (
                        <sup className='super'>
                          <a
                            href={tracked.trackedUrl}
                            onClick={tracked.onClick}
