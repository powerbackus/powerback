...
- **`/client/src/../`** The source directory holds all the front end source code for the React app portion of this project.
  ...
  - [`/src/utils`](../client/src/utils) Utility functions and helper scripts are placed in this folder. See [Client Utils](./utils.md) for a full catalog.
